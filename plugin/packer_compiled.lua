...
_G.packer_plugins = {
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/henry/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  playground = {
    loaded = true,
    path = "/home/henry/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["presence.nvim"] = {
    loaded = true,
    path = "/home/henry/.local/share/nvim/site/pack/packer/start/presence.nvim",
  ...
  undotree = {
    loaded = true,
    path = "/home/henry/.local/share/nvim/site/pack/packer/start/undotree",
